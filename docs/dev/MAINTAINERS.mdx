---
description: "lndart.cln HACKING guide"
---


# lndart.cln HACKING guide
...
Welcome to the HACKING guide and let's peek into how a day in the life of a lndart.cln maintainer looks like.
...
- Generate the changelog related to the package:
    ...
    - `make {changelog_lib|changelog_cmd|changelog}`, where
...
N.B: Part of this document is stolen from [core lightning] docs (https://github.com/ElementsProject/lightning/blob/master/doc/HACKING.md) by @rustyrussell 's experience.
