...
Welcome in the HACKING guide and how a day in a lndart.cln maintainer looks like.
...
The commit style is one of the more important concept to manage a monorepo like lndart.cln, and in particular
...
In particular, lndart.cln has the possibility to release one single package at the time, or
all together.
